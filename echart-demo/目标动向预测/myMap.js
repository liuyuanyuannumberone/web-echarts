(function () {
    ...
    let axiosData = [
        [XAData[0][0].name, XAData],
        [XNData[0][0].name, XNData],
        [YCData[0][0].name, YCData],
        [data1[0][0].name, data1],
        [data2[0][0].name, data2],
        [data3[0][0].name, data3],
        [data4[0][0].name, data4],
        [data5[0][0].name, data5],
        [data6[0][0].name, data6],
        [data7[0][0].name, data7],
    ];
    ...
    axiosData.forEach(function (item, i) {
        series.push(
            ...
            },
            {
                ...
                data: [{
                    name: item[0],
                    value: mapgeoCoord(item[0])[0].concat([item[0].value])
                }]
            },
            {
                name: mapgeoCoord(item[0])[1] + " Top3",
